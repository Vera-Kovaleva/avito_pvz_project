...
func (s *Server) PostPvz(ctx context.Context, request oapi.PostPvzRequestObject) (oapi.PostPvzResponseObject, error) {
...
func (s *Server) GetPvz(ctx context.Context, request oapi.GetPvzRequestObject) (oapi.GetPvzResponseObject, error) {
	panic("unimplemented")
}
